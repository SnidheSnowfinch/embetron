...
<div class="slider">
    <div class="slide active">
        ...
        <div class="hero-content">
            ...
            <a class="top-btn">Get A Quote <i class="bi bi-arrow-up-right"></i></a>
        </div>
    </div>
...
<section class="section-img">
    ...
    <div class="right">
        ...
        <h2>We Strive To Lead The Way In The Solar Energy Industry.</h2>
        <p>
            Solar panels with PV cells convert sunlight directly into electricity. PV panels are often installed on
...
<div class="gray-div">
    ...
    <section class="work-section">
        ...
        <h5><i class="bi bi-sun"></i>Our works<i class="bi bi-sun"></i></h5>
        <div class="work-div">
