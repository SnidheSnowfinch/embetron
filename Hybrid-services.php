...
<section class="section-img">
    ...
    <div class="right">
        ...
        <p>A Hybrid solar systems combines the best from grid-tied and off-grid solar systems. These systems can either be described as off-grid solar with utility backup power, or grid-tied solar with extra battery storage.</p>
     <p>If you own a grid-tied solar system and drive a vehicle that runs on electricity, you already kind of have a hybrid setup. The electrical vehicle is really just a battery with wheels.</p>
