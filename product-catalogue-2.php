...
<section class="section-img-flex">
    <div  class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
            <h5 class="fw-bold">Solar inverter catalogue </h5>
            <div class="img-card">
            <img class="" src="bootstrap/images/product-1.jpg" alt="" width="100%">
            <a href="" class="text-decoration-none"><div class="green-div-img-new">More About Us <i class="bi bi-arrow-up-right mx-2"></i></div></a>

            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
        <h5 class="fw-bold">Solar Pv Module catalogue </h5>
